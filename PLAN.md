...
| Step 4B: CLI dry-run wiring to engine metadata | `DONE` | 2026-02-25 12:34Z | Remove hardcoded stage string in `run --dry-run`; render stage order from orchestrator/core metadata. |
...
### Step 4B: CLI dry-run wiring to engine metadata (`DONE`)
