...
func TestPlannerKeepsIntegrationTestContractAheadOfInputEncoders(t *testing.T) {
	adapter := NewDeterministicPlanner()
...
func TestPlannerKeepsIntegrationTestContractAheadOfModelContract(t *testing.T) {
	adapter := NewDeterministicPlanner()
